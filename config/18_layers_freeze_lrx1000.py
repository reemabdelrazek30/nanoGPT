...
out_name = f"{timestamp}_18_layers_freeze_lrx1000_edited_grad_norm"
n_layer= 18
out_dir = out_name
eval_interval = 1000
eval_iters = 500
...
max_iters = 20000
device = 'cuda'
learning_rate = 3e-6 * 1000
decay_lr = True
freeze = True
warmup_iters = 1000 # how many steps to warm up for
lr_decay_iters = max_iters - 100 # should be ~= max_iters per Chinchilla
min_lr = min(3e-7,0.1 * learning_rate)  # minimum learning rate, should be ~= learning_rate/10 per Chinchilla